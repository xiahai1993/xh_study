package cn.spark.study.streaming.driverfailed;
...
//        JavaStreamingContext jsc = new JavaStreamingContext(conf, Durations.seconds(5));//Durations.seconds(5)设置每隔5秒
        ...
        JavaDStream<String> words = lines.flatMap(
                new FlatMapFunction<String,String>() {
                    private static final long serialVersionUID = -6464124454250826745L;
        ...
        JavaPairDStream<String,Integer> pairs  = words.mapToPair(new PairFunction<String, String, Integer>() {
            private static final long serialVersionUID = -4254501432661393317L;
        ...
        JavaPairDStream<String,Integer> wordscount = pairs.reduceByKey(new Function2<Integer, Integer, Integer>() {
            private static final long serialVersionUID = 2542122144165301683L;
